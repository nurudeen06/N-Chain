...
if (!CRYPTOBOX_WORDPRESS) { // Pure PHP
    ...
    require_once( "../users/payment_confirmation.php" );
}
...
class Cryptobox {
	...
	* Payment received successfully - https://coins.gourl.io/b/20/c/Bitcoin/p/20AAvZCcgBitcoin77BTCPUB0xyyeKkxMUmeTJRWj7IZrbJ0oL/a/0/au/0.1/pe/NOEXPIRY/l/en/o/invoice1/u/demo/us/MANUAL/j/1/d/ODIuMTEuOTQuMTIx/h/ac7733d264421c8410a218548b2d2a2a
	...
	public function display_cryptobox_bootstrap ($coins = array(), $def_coin = "", $def_language = "en", $custom_text = "", $coinImageSize = 70, $qrcodeSize = 200, $show_languages = true, $logoimg_path = "default", $resultimg_path = "default", $resultimgSize = 250, $redirect = "", $method = "curl", $debug = false)
	{
	    ...
	    // ------------------------------
	    $tmp .= "<div class='".$ext."loader' style='height:300px;width:400px'>";
        ...
        if (isset($_POST["".$ext."refresh_"]) || isset($_POST["".$ext."refresh2_"]))
        {
	            ...
	            $tmp .= "<div class='container'>";
	            $tmp .= "<div class='row'>";
	            $tmp .= "<div class='col-12 col-sm-10 offset-sm-1 mb-5 text-left'>";
	     ...
	     if ($logoimg_path)
	     {
	         $offset = ($show_languages) ? "" : "";
	         $tmp .= "<div class='".$ext."box_logo col-12 ".(CRYPTOBOX_WORDPRESS?"col-sm-10 col-md-7":"col-sm-6 col-md-8")." mt-4 $offset'>";
    	     $tmp .= "<div class='text-right'><img style='max-width:170px;max-height:40px;' class='".$ext."logo_image' alt='logo' src='#'></div>";
    	     $tmp .= "<br>";
    	     $tmp .= "</div>";
	     }
    	 // End - A4. Logo
	     ...
	     $tmp .= "<div class='container ".$ext."cryptobox_unpaid' " . $hide . " style='display:flex;align-items:center'>";
	     $tmp .= "<div class='row' style='display:flex;align-items:center'>";

	     $tmp .= "<div class='col-12 ".(CRYPTOBOX_WORDPRESS?"col-md-10 offset-md-1":"text-center col-sm-8 offset-sm-1 col-md-6 offset-md-2")."'>";

	     $tmp .= "<form action='" . $page_url . "' method='post'>";
	     $tmp .= "<div class='card box-shadow' style='display:flex;align-self:center'>";
	     $tmp .= "<div class='card-header'>";
